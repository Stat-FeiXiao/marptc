...
#' toydata - a toy simulated dataset from the marginal promotion time cure model
#'
#' @description toydata is a toy simulated dataset from marginal promotion time cure model with exchangeable correlation structure.
#' The cure rate and censoring rate are around 20% and 30%, respectively. There are two covariates, where X1 is generated from Bernoulli(0.5) and
#' X2 is generated from uniform distribution U(-1,1). The intercept term is 0.5 and the corresponding true covariate effects are specified as 0.5 and 1, respectively.
#'
#' @format A data frame with 600 rows and 4 variables, including:
#' \describe{
#' \item{cens}{the censoring indicator}
#' \item{yyy}{the cure indicator}
#' \item{X1}{covariate 1 comes from b(1,0.5) distribution}
#' \item{X2}{covariate 2 comes from U(-1,1) distribution}
#' \item{id}{the cluster number}
#' \item{time}{the observed failure time}
#' }
#'
...
#' }
#'
#' @details Patients were treated at the Creighton University School of Dentistry from
